...
<head>
  ...
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css"
    ...
    <link rel="icon" href="/ExamenCoreccion/config/img/favicon.png">
    <link rel="stylesheet" href="/ExamenCoreccion/config/css/bootstrap.min.css">
    <link rel="stylesheet" href="/ExamenCoreccion/config/css/animate.css">
    <link rel="stylesheet" href="/ExamenCoreccion/config/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/ExamenCoreccion/config/css/themify-icons.css">
    <link rel="stylesheet" href="/ExamenCoreccion/config/css/flaticon.css">
    <link rel="stylesheet" href="/ExamenCoreccion/config/css/magnific-popup.css">
    <link rel="stylesheet" href="/ExamenCoreccion/config/css/slick.css">
    <link rel="stylesheet" href="/ExamenCoreccion/config/css/style.css">
    <link rel="stylesheet" href="/ExamenCoreccion/config/fonts/material-icon/css/material-design-iconic-font.min.css">
    <link rel="stylesheet" href="/ExamenCoreccion/config/vendor/jquery-ui/jquery-ui.min.css">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/ExamenCoreccion/Privada/CrearPedido.jsp">Crear Pedido</a>
                                </li>           
